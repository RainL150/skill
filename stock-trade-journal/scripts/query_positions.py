...
def print_positions_table(positions: list):
    ...
    print(f"\n{'='*90}")
    print(f"  {'代码':<12} {'数量':>10} {'均价':>10} {'总成本':>12} {'已实现盈亏':>12} {'最后交易':<12}")
    print(f"{'='*90}")
    ...
    for pos in positions:
        ...
        print(f"  {pos['ts_code']:<12} {qty_str:>10} {avg_cost:>10.2f} {cost:>12,.2f} {pnl_str:>12} {last_date:<12}")
...
def print_position_detail(pos: dict):
    """打印单个持仓详情"""
    print(f"\n{'='*50}")
